 ...
 */
final class Version20220901183606 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product_attribute_value_int (id INT AUTO_INCREMENT NOT NULL, entity_id INT NOT NULL, attribute_id INT NOT NULL, location_id INT DEFAULT NULL, value INT NOT NULL, INDEX IDX_A3C4CB4981257D5D (entity_id), INDEX IDX_A3C4CB49B6E62EFA (attribute_id), INDEX IDX_A3C4CB4964D218E (location_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
